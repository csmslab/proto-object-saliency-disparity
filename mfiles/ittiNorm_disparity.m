function h= ittiNorm_disparity(gPyr,collapseLevel)
...
for m = 1:size(gPyr,2)
      if ~strcmp(gPyr{m}.type,'Orientation') && ~strcmp(gPyr{m}.type,'Disparity')    
    ...
    elseif strcmp(gPyr{m}.type,'Orientation') || strcmp(gPyr{m}.type,'Disparity')
